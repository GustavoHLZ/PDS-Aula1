	...
	public JanelaAlterar(Produto p, Janela abrir) {
		...
		btnSalvar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				p.setNomedoproduto(txtNomeProduto.getText());
				p.setDescricao(txtDescricao.getText());
				p.setMarca(txtMarca.getText());
				p.setPreco (Float.parseFloat(txtPreco.getText()));
				p.setQuantidade(Integer.parseInt(txtQuantidade.getText()));
				p.setDatadevalidade(Integer.parseInt(txtDatadevalidade.getText()));
				...
				p.setAlergenicos(txtAlergenicos.getText());
				p.setCaloria(Integer.parseInt(txtCalorias.getText()));
			...
			gl_contentPane.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(btnSalvar, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnFechar, GroupLayout.PREFERRED_SIZE, 33, GroupLayout.PREFERRED_SIZE))
					.addGap(68))
		);
