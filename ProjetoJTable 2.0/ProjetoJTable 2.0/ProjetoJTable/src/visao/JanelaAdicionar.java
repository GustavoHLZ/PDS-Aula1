...
public class JanelaAdicionar extends JFrame {
	...
	public JanelaAdicionar (Janela listar ) {
		...
		btnCadastrar.setBounds(753, 566, 181, 31);
		btnCadastrar.setBackground(new Color(255, 255, 255));
		btnCadastrar.setIcon(new ImageIcon("C:\\Users\\Usuário\\eclipse-workspace\\ProjetoJTable 2.0\\ProjetoJTable 2.0\\ProjetoJTable\\Icones\\Salvar.png"));
		...
		btnFechar.setBounds(145, 566, 152, 31);
